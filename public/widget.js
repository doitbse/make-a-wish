...
`)}async function dt(t,e){let n=e.fontEmbedCSS!=null?e.fontEmbedCSS:e.skipFonts?null:await ct(t,e);if(n){let r=document.createElement("style"),o=document.createTextNode(n);r.appendChild(o),t.firstChild?t.insertBefore(r,t.firstChild):t.appendChild(r)}}async function te(t,e={}){let{width:n,height:r}=H(t,e),o=await R(t,e,!0);return await dt(o,e),await j(o,e),rt(o,e),await Q(o,n,r)}async function ee(t,e={}){let{width:n,height:r}=H(t,e),o=await te(t,e),i=await E(o),a=document.createElement("canvas"),s=a.getContext("2d"),l=e.pixelRatio||Y(),d=e.canvasWidth||n,u=e.canvasHeight||r;return a.width=d*l,a.height=u*l,e.skipAutoScale||J(a),a.style.width=`${d}`,a.style.height=`${u}`,e.backgroundColor&&(s.fillStyle=e.backgroundColor,s.fillRect(0,0,a.width,a.height)),s.drawImage(i,0,0,a.width,a.height),a}async function ut(t,e={}){return(await ee(t,e)).toDataURL()}function ft(t){if(!t)return"";let e=[],n=t,r=0;for(;n&&n!==document.body&&n!==document.documentElement&&r<6;){let o=n;if(o.id){e.unshift(`#${o.id}`);break}let i=o.tagName.toLowerCase(),a=o.parentElement;if(a){let s=Array.from(a.children).filter(l=>l.tagName===o.tagName);if(s.length>1){let l=s.indexOf(o)+1;i+=`:nth-of-type(${l})`}}e.unshift(i),n=a,r++}return e.length===0?t.tagName.toLowerCase():e.join(" > ")}function pt(t){let e=t.id?`#${t.id}`:"",n="";return typeof t.className=="string"&&t.className.trim()&&(n="."+t.className.trim().split(/\s+/).slice(0,2).join(".")),(t.tagName.toLowerCase()+e+n).slice(0,80)}function ht(t,e=120){let n=(t.textContent||"").replace(/\s+/g," ").trim();return n.length<=e?n:n.slice(0,e-1).trimEnd()+"..."}async function q(t){try{document.querySelectorAll("[data-maw-hover]").forEach(s=>s.removeAttribute("data-maw-hover"));let e=document.documentElement,n=await ut(e,{backgroundColor:"#ffffff",width:e.scrollWidth,height:e.scrollHeight,filter:s=>!((s instanceof HTMLElement||s instanceof SVGElement)&&(s.hasAttribute("data-maw-chrome")||s.tagName.toLowerCase()==="make-a-wish-widget"||s.closest&&(s.closest("[data-maw-chrome]")||s.closest("make-a-wish-widget"))))});if(t.length===0)return n;let r=new Image;r.src=n,await new Promise((s,l)=>{r.onload=()=>s(),r.onerror=()=>l(new Error("failed to load screenshot image"))});let o=document.createElement("canvas");o.width=r.naturalWidth,o.height=r.naturalHeight;let i=o.getContext("2d");if(!i)return n;i.drawImage(r,0,0);let a=o.width/e.scrollWidth;return t.forEach((s,l)=>{let d=(s.rect.x+window.scrollX)*a,u=(s.rect.y+window.scrollY)*a,c=13*a;i.beginPath(),i.arc(d,u,c,0,Math.PI*2),i.fillStyle="#fc3165",i.fill(),i.strokeStyle="#ffffff",i.lineWidth=2*a,i.stroke(),i.fillStyle="#ffffff",i.font=`bold ${14*a}px "Inter", -apple-system, sans-serif`,i.textAlign="center",i.textBaseline="middle",i.fillText(String(l+1),d,u)}),o.toDataURL("image/png")}catch(e){return console.error("[make-a-wish] screenshot capture failed:",e),null}}function F(t,e){let n=[],r=o=>{if(!o)return;let i=o.trim();if(i){if(i.startsWith("[")&&i.endsWith("]"))try{let a=JSON.parse(i);if(Array.isArray(a)){for(let s of a)typeof s=="string"&&s.trim()&&n.push(s.trim());return}}catch{}for(let a of i.split(",")){let s=a.trim();s&&!n.includes(s)&&n.push(s)}}};return r(t),r(e),Array.from(new Set(n))}var ne=[{label:"Bug",emoji:"\u{1F41B}"},{label:"Idea",emoji:"\u{1F4A1}"},{label:"Question",emoji:"\u2753"},{label:"Praise",emoji:"\u2764\uFE0F"}],U=class{constructor(e,n){this.isOpen=!1;this.isAnnotating=!1;this.isSubmitting=!1;this.isDone=!1;this.selectedCategory="Bug";this.textValue="";this.annotations=[];this.screenshotDataUrl=null;this.errorMessage=null;this.modalPos=null;this.shouldFocusTextarea=!1;this.annotationOverlay=null;this.annotationPill=null;this.hoveredElement=null;this.pinElements=[];this.root=e,this.config=n,window.addEventListener("resize",()=>{if(this.modalPos&&this.isOpen){let r=this.root.querySelector(".maw-modal");if(r){let o=r.getBoundingClientRect(),i=8,a=Math.max(i,window.innerWidth-o.width-i),s=Math.max(i,window.innerHeight-o.height-i);this.modalPos.x=Math.max(i,Math.min(a,this.modalPos.x)),this.modalPos.y=Math.max(i,Math.min(s,this.modalPos.y)),r.style.left=`${this.modalPos.x}px`,r.style.top=`${this.modalPos.y}px`}}}),this.render()}updateConfig(e){this.config={...this.config,...e},this.render()}hasMeaningfulText(){return this.textValue.replace(/\(\d+\)\s*/g,"").trim().length>0}render(){this.root.innerHTML=`
    ...
    `,document.body.appendChild(n),this.annotationPill=n,n.addEventListener("pointerdown",a=>{if(a.target.closest("button")||a.button!==0)return;a.preventDefault(),n.style.cursor="grabbing";let s=n.getBoundingClientRect(),l=a.clientX,d=a.clientY,u=s.left,c=s.top;n.style.left=`${u}px`,n.style.top=`${c}px`,n.style.right="auto",n.style.bottom="auto";let p=T=>{let L=T.clientX-l,A=T.clientY-d,b=u+L,x=c+A,w=8;b=Math.max(w,Math.min(window.innerWidth-s.width-w,b)),x=Math.max(w,Math.min(window.innerHeight-s.height-w,x)),n.style.left=`${b}px`,n.style.top=`${x}px`},g=()=>{n.style.cursor="grab",window.removeEventListener("pointermove",p),window.removeEventListener("pointerup",g),window.removeEventListener("pointercancel",g)};window.addEventListener("pointermove",p),window.addEventListener("pointerup",g),window.addEventListener("pointercancel",g)}),!document.getElementById("maw-hover-style")){let a=document.createElement("style");a.id="maw-hover-style",a.innerHTML="[data-maw-hover] { outline: 2px solid #fc3165 !important; outline-offset: 2px !important; cursor: crosshair !important; }",document.head.appendChild(a)}let r=(a,s)=>{e.style.pointerEvents="none";let l=document.elementFromPoint(a,s);return e.style.pointerEvents="auto",!l||l.closest("[data-maw-chrome]")||l.closest("make-a-wish-widget")?null:l};e.onmousemove=a=>{let s=r(a.clientX,a.clientY);s!==this.hoveredElement&&(this.hoveredElement&&this.hoveredElement.removeAttribute("data-maw-hover"),s&&s.setAttribute("data-maw-hover",""),this.hoveredElement=s)},e.onclick=a=>{a.preventDefault(),a.stopPropagation();let s=r(a.clientX,a.clientY);if(!s)return;let l=s.getBoundingClientRect(),d={selector:ft(s),tag:s.tagName.toLowerCase(),hint:pt(s),text:ht(s),rect:{x:l.x,y:l.y,width:l.width,height:l.height}};this.annotations.push(d),this.renderPin(d,this.annotations.length);let u=n.querySelector("#mawPillText");u&&(u.textContent=`Click elements to pin (${this.annotations.length})`);let c=this.annotations.length;c===1?this.textValue.trim()?this.textValue.includes("(1)")||(this.textValue=this.textValue.trimEnd()+`
(1) `):this.textValue="(1) ":c>1&&(this.textValue.includes(`(${c})`)||(this.textValue=this.textValue.trimEnd()+`
(${c}) `))};let o=n.querySelector("#mawDoneAnnotateBtn");o&&o.addEventListener("click",async()=>{await this.finishAnnotation(!0)});let i=n.querySelector("#mawCancelAnnotateBtn");i&&i.addEventListener("click",async()=>{await this.finishAnnotation(!1)})}renderPin(e,n){let r=document.createElement("div");r.setAttribute("data-maw-chrome",""),r.style.position="fixed",r.style.left=`${e.rect.x}px`,r.style.top=`${e.rect.y}px`,r.style.width="24px",r.style.height="24px",r.style.borderRadius="9999px",r.style.background="#fc3165",r.style.color="#ffffff",r.style.fontFamily="'Inter', -apple-system, sans-serif",r.style.fontSize="12px",r.style.fontWeight="700",r.style.display="flex",r.style.alignItems="center",r.style.justifyContent="center",r.style.boxShadow="0 0 0 2px #ffffff, 0 4px 10px rgba(252, 49, 101, 0.4)",r.style.zIndex="2147483644",r.style.pointerEvents="none",r.textContent=String(n),document.body.appendChild(r),this.pinElements.push(r)}async finishAnnotation(e){if(this.hoveredElement&&(this.hoveredElement.removeAttribute("data-maw-hover"),this.hoveredElement=null),this.annotationOverlay&&(this.annotationOverlay.remove(),this.annotationOverlay=null),this.annotationPill&&(this.annotationPill.remove(),this.annotationPill=null),this.pinElements.forEach(n=>n.remove()),this.pinElements=[],e){let n=await q(this.annotations);if(this.screenshotDataUrl=n,this.annotations.length>0){this.textValue.trim()?this.textValue.includes("(1)")||(this.textValue=this.textValue.trimEnd()+`
(1) `):this.textValue="(1) ";for(let r=2;r<=this.annotations.length;r++)this.textValue.includes(`(${r})`)||(this.textValue=this.textValue.trimEnd()+`
(${r}) `)}this.shouldFocusTextarea=!0}else this.textValue==="(1) "&&(this.textValue=""),this.annotations=[];this.isAnnotating=!1,this.render()}async submitFeedback(){if(!this.hasMeaningfulText()||this.isSubmitting)return;this.isSubmitting=!0,this.errorMessage=null,this.render();let e=this.screenshotDataUrl;e||(e=await q(this.annotations),this.screenshotDataUrl=e);let n=this.config.repos&&this.config.repos.length>0?this.config.repos:this.config.repo?[this.config.repo]:[],r=n[0]||this.config.repo||"",o={appId:this.config.appId||"default-app",repo:r,repos:n,category:this.selectedCategory,text:this.textValue.trim(),annotations:this.annotations,screenshot:e,url:window.location.href,userAgent:navigator.userAgent,userEmail:this.config.userEmail||"",timestamp:new Date().toISOString()};try{let i=(this.config.apiUrl||window.location.origin).replace(/\/$/,""),a=await fetch(`${i}/api/feedback`,{method:"POST",headers:{"Content-Type":"application/json","X-Make-A-Wish-App":this.config.appId||"generic"},body:JSON.stringify(o)});if(!a.ok){let s=await a.text();throw new Error(`Submission failed (${a.status}): ${s.slice(0,150)}`)}this.isDone=!0,this.isSubmitting=!1,this.render()}catch(i){this.isSubmitting=!1,this.errorMessage=i instanceof Error?i.message:"Submission failed",this.render()}}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}};var _=class extends HTMLElement{constructor(){super();this.ui=null;this.shadow=this.attachShadow({mode:"open"})}static get observedAttributes(){return["data-app","data-repo","data-repos","data-api","data-user","data-position"]}connectedCallback(){let n=this.resolveConfig();this.ui=new U(this.shadow,n)}attributeChangedCallback(n,r,o){if(!this.ui)return;let i={};if(n==="data-app"&&(i.appId=o),n==="data-repo"||n==="data-repos"){let a=F(this.getAttribute("data-repos"),this.getAttribute("data-repo"));i.repos=a,i.repo=a[0]||""}n==="data-api"&&(i.apiUrl=o),n==="data-user"&&(i.userEmail=o),n==="data-position"&&(i.position=o),this.ui.updateConfig(i)}resolveConfig(){let n=F(this.getAttribute("data-repos"),this.getAttribute("data-repo"));return{appId:this.getAttribute("data-app")||"",repo:n[0]||"",repos:n,apiUrl:this.getAttribute("data-api")||window.location.origin,userEmail:this.getAttribute("data-user")||void 0,position:this.getAttribute("data-position")||"bottom-right"}}};typeof window<"u"&&!customElements.get("make-a-wish-widget")&&customElements.define("make-a-wish-widget",_);function mt(){if(typeof document>"u")return;let t=document.currentScript||document.querySelector('script[src*="widget.js"]'),e=window.location.origin,n="",r="",o="",i="",a="bottom-right";if(t){try{e=new URL(t.src,window.location.href).origin}catch{e=window.location.origin}n=t.getAttribute("data-app")||"";let s=t.getAttribute("data-repos"),l=t.getAttribute("data-repo"),d=F(s,l);o=t.getAttribute("data-api")||e,i=t.getAttribute("data-user")||"";let u=t.getAttribute("data-position");if((u==="bottom-left"||u==="bottom-right")&&(a=u),document.querySelector("make-a-wish-widget"))return;let c=document.createElement("make-a-wish-widget");n&&c.setAttribute("data-app",n),d.length>0&&(c.setAttribute("data-repos",d.join(", ")),c.setAttribute("data-repo",d[0])),o&&c.setAttribute("data-api",o),i&&c.setAttribute("data-user",i),c.setAttribute("data-position",a),document.body.appendChild(c)}else if(!document.querySelector("make-a-wish-widget")){let s=document.createElement("make-a-wish-widget");document.body.appendChild(s)}}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",mt):mt());})();
